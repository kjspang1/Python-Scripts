# -*- coding: utf-8 -*-
"""
Created on Thu Dec 23 12:50:35 2021
...
team_ids = accounts.acell('K37').value
team_roles = accounts.acell('L37').value
...
wb1.save("D://Users//kevinspang//Documents//Excel//Accounts Reports//Sami Kaminski//Accounts_Report_Sami_Kaminski_{}.xlsx".format(today_save))
wb1.close()
wb2.close()
app.kill()