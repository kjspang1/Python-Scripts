# -*- coding: utf-8 -*-
"""
Created on Thu Dec 23 12:54:20 2021
...
team_ids = accounts.acell('O37').value
team_roles = accounts.acell('P37').value
...
wb1.save("D://Users//kevinspang//Documents//Excel//Accounts Reports//Will Rice//Accounts_Report_Will_Rice_{}.xlsx".format(today_save))
wb1.close()
wb2.close()
app.kill()