# -*- coding: utf-8 -*-
"""
Created on Thu Dec 23 12:43:42 2021
...
team_ids = accounts.acell('I37').value
team_roles = accounts.acell('J37').value
...
wb1.save("D://Users//kevinspang//Documents//Excel//Accounts Reports//Hannah Lucas//Accounts_Report_Hannah_Lucas_{}.xlsx".format(today_save))
wb1.close()
wb2.close()
app.kill()